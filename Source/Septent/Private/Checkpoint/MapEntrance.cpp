                                   ...
                                   UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	{
		bReached = true;
		if (ASeptentGameModeBase* SeptentGameModeBase = Cast<ASeptentGameModeBase>(UGameplayStatics::GetGameMode(this)))
		{
			SeptentGameModeBase->SaveWorldState(GetWorld(), DestinationMap.ToSoftObjectPath().GetAssetName());
		}
